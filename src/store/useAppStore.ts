...
interface AppState {
  ...
  addBooking: (booking: Omit<ServiceBookingRecord, 'id' | 'createdAt'>) => void;
...
export const useAppStore = create<AppState>((set) => ({
  ...
  addBooking: (booking) =>
    set((state) => ({
      ...
      transactions: [
        {
          ...
          description: `服务扣费 - ${booking.serviceName}(${booking.duration}小时)`,
      ...
      totalConsume: state.totalConsume + booking.totalAmount,
    })),
